...
(function () {
   ...
   *
   * Any arguments after `namespace` are passed to {@link ReMix#add}.
   * @constructor
   * @alias ReMix
   * @public
   * @param {ReMix~Namespace} [namespace] - The namespace for this ReMix object.
   * @param {ReMix~AddSpec} spec - Specification for this ReMix object.
   */
   ...
   * parameter must be a {@link ReMix~RegisterMatchSpec} object otherwise
   * a single argument is expected and should be a {@link ReMix~RegisterMatchObject}.
   * @returns {ReMix}
   * @category Template
   */
  ...
  /**
   * Get the regular expression registered by {@code identifier}.
   * @see {@link module:lib/remix.register}
   ...
   * @param {ReMix~AddSpec} spec - The specification to resolve under the give namespace.
   * @category Resolve
   */
   ...
   * @private
   * @param {ReMix~AddSpec} spec - Specification to resolve.
   * @returns this
   * @category Resolve
   */
   ...
   * @param {...ReMix~AddSpec} spec - All arguments are flattened into a single specification.
   * @returns this
   * @categroy Match
   */
   ...
   * @param {...ReMix~AddSpec} spec - The remaining arguments are consumed as the spec.
   * @returns this
   * @categroy Match
   */
   ...
   * @property {ReMix~AddSpec} spec - Specification to fall under `name` namespace.
   */
  /**
   ...
   *
   * @typedef {Object.<ReMix~Namespace, ReMix~AddSpec>} ReMix~Pairs
   * @category Resolve
   */
  /**
   * @typedef {(RegExp|ReMix~SetupCallback|ReMix~NamedRegExp|ReMix~Template|ReMix~Spec[]|ReMix~Pairs)} ReMix~AddSpec
   * @category Resolve
   */
  /**
