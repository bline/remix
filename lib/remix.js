...
(function () {
  ...
  Re.prototype.options = function (opt) {
    if (opt) _.merge(this._opt, opt);
    this._spec.options(opt);
    return this._opt;
  };
  Re.prototype.namespace = function (namespace) {
    if (namespace) {
      this._namespace = namespace;
      this._spec.namespace(namespace);
    }
    return this._namespace;
  };
  Re.prototype.setLastIndex = function (index) {
    this._spec.setLastIndex(index);
  };
