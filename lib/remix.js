...
(function () {
  ...
  ReMix._resolveTemplate = function (str) {
      ...
      str = str.replace(ReMix.RE.templates, ReMix.resolveVariable);
  ...
  ReMix.prototype._resolveSpec = function (spec) {
    ...
    if (_.isRegExp(spec)) {
      ...
      return this._resolveSpec(ReMix.resolveTemplate(spec));
  ...
  ReMix.prototype.add = function (specs) {
    this._specs = this._specs.concat(_.flatten(this._resolveSpec(specs)));
    return this;
  };
  ...
  ReMix.prototype.compile = function (force) {
    ...
    var matches = this._matches = [], id = this._id;
    this._regexn = _.reduce(this._specs, function (regexn, re, idx) {
      ...
      if (last && ReMix._canJoin(last[0], re)) {
